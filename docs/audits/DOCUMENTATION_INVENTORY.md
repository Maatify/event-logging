...
| `./docs/architecture/ADMIN_QUERY_DIAGNOSTICS_TELEMETRY_BLUEPRINT.md` | Architecture Docs | Active (Owner Approved / Implementation Pending) | Blueprint for DiagnosticsTelemetry Admin Query API | Runtime is authorized but not implemented. Defines new Admin Query API for DiagnosticsTelemetry. |
...
| `./docs/roadmap/ADMIN_QUERY_API_ROADMAP.md` | Roadmap Docs | Active | Current post-v1 execution roadmap | Phase 4 gate: DiagnosticsTelemetry Blueprint Approved / Runtime Implementation Next. |
