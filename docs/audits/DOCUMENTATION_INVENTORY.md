...
| `./docs/architecture/ADMIN_QUERY_API_ARCHITECTURE.md` | Architecture Docs | Active | Approved post-v1 architecture | Phase 3 Remediation Complete / Phase 4 Active / DiagnosticsTelemetry Blueprint Approved / Runtime Next. |
