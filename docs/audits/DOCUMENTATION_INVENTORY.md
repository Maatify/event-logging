...
| `./docs/architecture/ADMIN_QUERY_DELIVERY_OPERATIONS_BLUEPRINT.md` | Architecture Docs | Active | Proposed Admin Query API architecture for DeliveryOperations | Blueprint defining complete package-owned Admin filtering capabilities |
