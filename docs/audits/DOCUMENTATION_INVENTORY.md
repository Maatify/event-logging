...
| `./docs/architecture/ADMIN_QUERY_API_ARCHITECTURE.md` | Architecture Docs | Active | Approved post-v1 architecture | Phase 0 and 1 Complete / Post-v1.0 Pagination Remediation Planned. AuditTrail Runtime implemented. BehaviorTrace Runtime implemented. SecuritySignals Runtime implemented. AuthoritativeAudit Runtime implemented. |
...
| `./docs/architecture/ADMIN_QUERY_DIAGNOSTICS_TELEMETRY_BLUEPRINT.md` | Architecture Docs | Active (Proposed / Owner Review Required) | Blueprint for DiagnosticsTelemetry Admin Query API | Runtime is not authorized. Defines new Admin Query API for DiagnosticsTelemetry. |
...
| `./docs/roadmap/ADMIN_QUERY_API_ROADMAP.md` | Roadmap Docs | Active | Current post-v1 execution roadmap | Phase 4 gate: DiagnosticsTelemetry Blueprint Owner Review Pending. |
