...
| `./docs/roadmap/ADMIN_QUERY_API_ROADMAP.md` | Roadmap Docs | Active | Current post-v1 execution roadmap | Phase 4 is complete; DeliveryOperations Runtime is Pending Merge; reporting/dashboard remains blocked; no release or tag is authorized. |
