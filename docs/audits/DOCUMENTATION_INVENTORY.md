...
| `./docs/architecture/ADMIN_QUERY_API_ARCHITECTURE.md` | Architecture Docs | Active | Approved post-v1 architecture | Phase 4 Complete / DeliveryOperations Runtime Implemented. |
...
| `./docs/architecture/ADMIN_QUERY_DELIVERY_OPERATIONS_BLUEPRINT.md` | Architecture Docs | Active (Owner Approved / Runtime Implemented / Complete) | Approved Admin Query API architecture for DeliveryOperations | Blueprint defining complete package-owned Admin filtering capabilities. Runtime is complete. |
...
| `./docs/roadmap/ADMIN_QUERY_API_ROADMAP.md` | Roadmap Docs | Active | Current post-v1 execution roadmap | Phase 4 is complete; DeliveryOperations Runtime is complete; reporting/dashboard remains blocked; no release or tag is authorized. |
