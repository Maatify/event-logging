...
| `./docs/architecture/ADMIN_QUERY_AUTHORITATIVE_AUDIT_REBUILD_BLUEPRINT.md` | Architecture Docs | Active (Proposed / Pending Owner Approval) | Blueprint for AuthoritativeAudit Admin Query API | Proposed blueprint. |
