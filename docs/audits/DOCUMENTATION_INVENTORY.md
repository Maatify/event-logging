...
| `./docs/architecture/ADMIN_QUERY_AUTHORITATIVE_AUDIT_REBUILD_BLUEPRINT.md` | Blueprint | Active | Blueprint for AuthoritativeAudit Admin Query API | Approved, pending implementation. |
