...
$content = preg_replace('/    public function testExistingStorageExceptionIsNotRewrapped\(\): void.*$/s', '
    public function testExistingStorageExceptionIsNotRewrapped(): void
    {
        ...
        // Paginator is instantiated internally. We can replace it via reflection.
        ...
        // When paginator is called, we will throw the AuthoritativeAuditStorageException
        // The repository catches PaginationExecutionException | PDOException.
        // It does not catch AuthoritativeAuditStorageException, so it should bubble up.
