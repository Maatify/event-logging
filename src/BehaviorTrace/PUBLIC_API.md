...
**Class:** `Maatify\EventLogging\BehaviorTrace\Recorder\BehaviorTraceRecorder`
...
**Interface:** `Maatify\EventLogging\BehaviorTrace\Contract\BehaviorTraceQueryInterface`
...
**Policy:**
- `Maatify\EventLogging\BehaviorTrace\Contract\BehaviorTracePolicyInterface`
- Can be implemented to override validation rules (e.g., allow different Actor Types).

**Enums:**
- `Maatify\EventLogging\BehaviorTrace\Enum\BehaviorTraceActorTypeInterface`
...
**Do NOT use directly:**
- `Maatify\EventLogging\BehaviorTrace\Infrastructure\**`
...
**Read-Only:**
- `Maatify\EventLogging\BehaviorTrace\DTO\BehaviorTraceEventDTO` (Output of Read)
- `Maatify\EventLogging\BehaviorTrace\DTO\BehaviorTraceContextDTO`
- `Maatify\EventLogging\BehaviorTrace\DTO\BehaviorTraceCursorDTO` (Input for Read)
