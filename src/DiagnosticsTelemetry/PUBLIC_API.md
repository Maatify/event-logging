...
**Class:** `Maatify\EventLogging\DiagnosticsTelemetry\Recorder\DiagnosticsTelemetryRecorder`
...
**Interface:** `Maatify\EventLogging\DiagnosticsTelemetry\Contract\DiagnosticsTelemetryQueryInterface`
...
**Policy:**
- `Maatify\EventLogging\DiagnosticsTelemetry\Contract\DiagnosticsTelemetryPolicyInterface`
- Can be implemented to override validation rules (e.g., allow different Actor Types).

**Enums:**
- `Maatify\EventLogging\DiagnosticsTelemetry\Enum\DiagnosticsTelemetrySeverityInterface`
- `Maatify\EventLogging\DiagnosticsTelemetry\Enum\DiagnosticsTelemetryActorTypeInterface`
...
**Do NOT use directly:**
- `Maatify\EventLogging\DiagnosticsTelemetry\Infrastructure\**`
...
**Read-Only:**
- `Maatify\EventLogging\DiagnosticsTelemetry\DTO\DiagnosticsTelemetryEventDTO` (Output of Read)
- `Maatify\EventLogging\DiagnosticsTelemetry\DTO\DiagnosticsTelemetryContextDTO`
- `Maatify\EventLogging\DiagnosticsTelemetry\DTO\DiagnosticsTelemetryCursorDTO` (Input for Read)
