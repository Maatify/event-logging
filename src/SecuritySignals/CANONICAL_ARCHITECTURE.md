...
### Recorder (`Maatify\EventLogging\SecuritySignals\Recorder\SecuritySignalsRecorder`)
...
### DTO (`Maatify\EventLogging\SecuritySignals\DTO\*`)
- **Responsibility**: Immutable data transfer.
- **Rules**: Strict typing, 1:1 mapping with Database Schema.

### Contract (`Maatify\EventLogging\SecuritySignals\Contract\*`)
- **Responsibility**: Define interfaces for Logger and Policy.

### Infrastructure (`Maatify\EventLogging\SecuritySignals\Infrastructure\*`)
